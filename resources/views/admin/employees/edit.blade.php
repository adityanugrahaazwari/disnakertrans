...
<div class="card">
    ...
    <form action="{{ route('admin.profile.structure.update', $employee->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div style="display: flex; gap: 10px;">
            <button type="submit" class="btn-login" style="width: auto; padding: 10px 25px;">Perbarui Data</button>
            <a href="{{ route('admin.profile.structure.index') }}" style="padding: 10px 25px; text-decoration: none; color: #6b7280; border: 1px solid #d1d5db; border-radius: 6px;">Batal</a>
        </div>
    </form>
</div>
@endsection
