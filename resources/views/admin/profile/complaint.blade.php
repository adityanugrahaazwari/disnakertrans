...
<div class="card">
    ...
    <form action="{{ route('admin.profile.complaint.update') }}" method="POST">
        ...
        <div style="margin-bottom: 24px;">
            ...
            @error('pengaduan_title') <small style="color: var(--danger);">{{ $message }}</small> @enderror
        </div>
        ...
        <div style="margin-bottom: 24px;">
            ...
            @error('pengaduan_description') <small style="color: var(--danger);">{{ $message }}</small> @enderror
        </div>
        ...
        <div style="margin-bottom: 32px;">
            ...
            @error('pengaduan_wa') <small style="color: var(--danger);">{{ $message }}</small> @enderror
        </div>
