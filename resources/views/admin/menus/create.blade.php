    ...
    <form action="{{ route('admin.menus.store') }}" method="POST">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
            ...
            <div>
                ...
                <input type="text" name="icon" value="{{ old('icon') }}" placeholder="fas fa-home" style="width: 100%; padding: 12px; border: 1px solid #d1d5db; border-radius: 6px; box-sizing: border-box;">
        ...
        <div style="margin-bottom: 20px;">
            ...
            <input type="text" name="url" value="{{ old('url') }}" required placeholder="/posts" style="width: 100%; padding: 12px; border: 1px solid #d1d5db; border-radius: 6px; box-sizing: border-box;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 30px;">
            <div>
                ...
                <input type="number" name="order" value="{{ old('order', 0) }}" style="width: 100%; padding: 12px; border: 1px solid #d1d5db; border-radius: 6px; box-sizing: border-box;">
