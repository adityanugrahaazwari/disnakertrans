...
@section('header_title', 'Tambah Tag')

@section('content')
<div class="card">
    <h3 style="margin-top:0;">Buat Tag Baru</h3>
    ...
    <form action="{{ route('admin.tags.store') }}" method="POST">
        ...
        <div style="display: flex; gap: 10px;">
            <button type="submit" class="btn-login" style="width: auto; padding: 10px 25px;">Simpan Tag</button>
